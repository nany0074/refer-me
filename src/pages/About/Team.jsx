...
const teamMembers = [
    ...
    },
    {
        ...
        twitter: null,
        github: null,
        bio: 'Saroj excels at identifying top-tier talent and building strong, lasting relationships. Her expertise ensures that both companies and candidates find their perfect match.',
        video: null,
    },
    {
        id: 3,
        ...
        github: null,
        bio: 'An industry veteran with 20+ years experience, He crafts cutting-edge training programs that equip professionals with in-demand skills for career advancement.',
        video: null,
    },
    {
        id: 4,
        ...
        twitter: null,
        github: null,
        bio: 'Snehal is the heart of our "Referme-ians" community, fostering engagement and ensuring every member feels supported and connected throughout their journey.',
        video: null,
    },
    {
        id: 5,
        ...
        twitter: null,
        github: null,
        bio: 'Aastha specializes in crafting personalized placement strategies, guiding candidates through interview prep and resume optimization to secure their ideal roles.',
        video: null,
    },
    {
        id: 6,
        ...
        twitter: null,
        github: null,
        bio: 'Gunjan provides invaluable career guidance, helping professionals navigate their paths, identify strengths, and overcome challenges to achieve their career goals.',
        video: null,
    },
    //  {
    //     id: 7,
    ...
    //     image: 'https://media.istockphoto.com/id/1326908594/photo/happy-business-women-and-teacher-with-headphones-using-laptop-for-video-call-stock-photo.jpg?s=612x612&w=0&k=20&c=R8B4RJ2aZzsFKgiQmWjwTgu5QEUY4Lf6_dA4Zp-97PE=',
    //     twitter: null,
    //     github: null,
    //     bio: 'Sara provides invaluable career guidance, helping professionals navigate their paths, identify strengths, and overcome challenges to achieve their career goals.',
    //     video: null,
    // },
    //  {
    //     id: 8,
    //     name: 'Nandini sharma',
    //     role: 'Career Counselor',
    //     image: 'https://media.istockphoto.com/id/1310208267/photo/portrait-of-indian-woman-as-a-teacher-in-sari-standing-isolated-over-white-background-stock.jpg?s=612x612&w=0&k=20&c=UpkNhqazjP4CNvndwC_Qus1SwAEc1ogPOGpIDmWd4bk=',
    //     twitter: null,
    //     github: null,
    //     bio: 'Sara provides invaluable career guidance, helping professionals navigate their paths, identify strengths, and overcome challenges to achieve their career goals.',
    //     video: null,
