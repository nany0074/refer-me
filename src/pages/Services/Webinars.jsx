...
import { FiCalendar, FiUsers, FiClock, FiSearch, FiMail, FiAward, FiMessageSquare } from 'react-icons/fi';
...
const Webinars = () => {
  ...
  const features = [
    { icon: <FiCalendar className="text-blue-600 text-lg" />, text: "Free Webinar" },
    { icon: <FiUsers className="text-blue-600 text-lg" />, text: "Industry Experts" },
    { icon: <FiAward className="text-blue-600 text-lg" />, text: "Certificate" },
    { icon: <FiMessageSquare className="text-blue-600 text-lg" />, text: "Live Q&A" }
  ];
 ...
 <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 ">
      ...
      >
        <div className="flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Expert-led <span className="text-blue-600">Free Webinars</span> To Upskill Your Career
          </h1>
          ...
          <div className="mb-8 bg-white p-6 rounded-xl shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <span className="text-blue-600 font-medium mr-2">FOCUS:</span>
                <span className="font-medium">Power Automate Some Workflow Quick</span>
              </div>
              <div className="flex items-center text-gray-600">
                <div className="flex items-center bg-blue-100 px-3 py-1 rounded-full mr-3">
                  <span className="text-blue-700 font-medium mr-1">{0.99}</span>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="space-y-6">
            {webinars.map((webinar, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className={`bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-lg transition-all ${webinar.featured ? 'border-blue-200 border-2' : ''}`}
              >
                {webinar.live && (
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-3">
                        ...
                        {webinar.rating && (
                          <span className="inline-flex items-center bg-blue-50 px-2 py-1 rounded-full text-xs">
                            <span className="text-blue-700 font-medium mr-1">{webinar.rating}</span>
                            <span className="text-yellow-400">★</span>
                          </span>
                        )}
                      </div>
                      <h3 className="text-xl font-semibold text-gray-900 leading-snug">{webinar.title}</h3>
                      <p className="text-gray-600 mt-2 flex items-center">
                        <span className="w-1 h-1 bg-gray-400 rounded-full mr-2"></span>
                        {webinar.speaker}
                      </p>
                    </div>
                    <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl hover:from-blue-700 hover:to-blue-600 transition-all shadow-md hover:shadow-lg whitespace-nowrap">
                      Join Now
                    </button>
                  </div>
        ...
        <div className="lg:w-1/3 space-y-6">
          ...
          >
            <h3 className="text-xl font-semibold text-gray-900 mb-6 pb-2 border-b border-gray-100">Our Webinar Impact</h3>
            <div className="space-y-6">
              <div>
                <p className="text-4xl font-bold text-blue-600 mb-1">2,500+</p>
                <p className="text-gray-600">Webinars conducted</p>
              </div>
              <div>
                <p className="text-4xl font-bold text-blue-600 mb-1">110,000+</p>
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-sm p-6"
          >
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Join our LinkedIn Group</h3>
            <p className="text-gray-600 mb-6">For daily updates and networking opportunities</p>
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-sm p-6"
          >
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Never Miss an Update</h3>
            <p className="text-gray-600 mb-6">Subscribe to our webinar newsletter</p>
            <div className="flex">
              <input
                type="email"
